              ...
              <form onSubmit={handleSearch} className="w-full md:w-auto">
                <div className="flex flex-col sm:flex-row w-full gap-2 sm:gap-0">
                  <input
                    ...
                    className="input-field rounded-lg sm:rounded-r-none w-full sm:w-48"
                    value={locationFilter}
                    onChange={(e) => setLocationFilter(e.target.value)}
                  />
                  <select
                    className="input-field rounded-lg sm:rounded-none sm:border-l-0 w-full sm:w-36 cursor-pointer bg-white"
                    value={typeFilter}
                  ...
                  <button type="submit" className="bg-primary text-primary-foreground px-4 py-2.5 rounded-lg sm:rounded-l-none sm:rounded-r-lg hover:bg-primary/90 transition-colors font-bold text-center">
                    Filtrer
                  </button>
                </div>
              </form>
